    ...
    public static void main(String[] args) {
        try {
            ...
            do {
                ...
                switch (opcion) {
                    case 1:
                        webResource = client.resource("http://localhost:8080/myapp/employees");
                    ...
                    case 2:
                        webResource = client
                                .resource("http://localhost:8080/myapp/employees");
                    ...
                    case 3:
                        ...
                        webResource = client.resource("http://localhost:8080/myapp/employees/" + id);
